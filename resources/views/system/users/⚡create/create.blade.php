            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-6">
                    <flux:fieldset>
                        ...
                        <flux:description>{{ __('system.users.create.general.description') }}</flux:description>

                        <flux:input size="sm" wire:model="name" :label="__('system.users.create.form.name')" type="text" required autofocus autocomplete="off" />

                        <flux:input size="sm" wire:model="email" :label="__('system.users.create.form.email')" type="email" required autocomplete="off" />
                    </flux:fieldset>

                    <flux:fieldset>
                        <flux:legend>{{ __('system.users.create.passwords.title') }}</flux:legend>
                        <flux:description>{{ __('system.users.create.passwords.description') }}</flux:description>
                        ...
                        <div wire:key="manual-password-fields" @class(['space-y-4', 'hidden' => $auto_password])>
                            <flux:input size="sm" wire:model="password" :label="__('system.users.create.form.password')" type="password" autocomplete="off" viewable :disabled="$auto_password" />
                ...
                <div class="space-y-6">
                    <flux:fieldset>
                        ...
                        <flux:description>{{ __('system.users.create.roles.description') }}</flux:description>
                    ...
                    <flux:fieldset>
                        ...
                        <flux:description>{{ __('system.users.create.permissions.description') }}</flux:description>
