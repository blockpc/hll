    ...
    'clans' => [
        ...
        'soldiers' => [
            ...
            'table' => [
                ...
                'level' => 'Nivel',
                'rosters_count' => '# Rosters',
                'actions' => 'Acciones',
                'search_soldiers' => 'Buscar soldados...',
            ],
            'create' => [
            ...
            'form' => [
                ...
                'rcon' => 'RCON del Soldado (opcional)',
                'level' => 'Nivel del Soldado (opcional)',
                'validations' => [
                    'name_required' => 'El nombre del soldado es obligatorio.',
                    'name_unique' => 'Ya existe un soldado con este nombre en el clan.',
                    'name_max' => 'El nombre del soldado no debe superar los 32 caracteres.',
                    'role_enum' => 'El rol del soldado no es válido.',
                    'observation_max' => 'La observación del soldado no debe superar los 255 caracteres.',
                    'rcon_max' => 'El RCON del soldado no debe superar los 255 caracteres.',
                    'level_integer' => 'El nivel del soldado debe ser un número entero.',
                    'level_min' => 'El nivel del soldado no puede ser menor a 0.',
                    'level_max' => 'El nivel del soldado no puede ser mayor a 500.',
                ],
            ],
            'import' => [
